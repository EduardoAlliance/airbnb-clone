...
export default function PolicyEdit({ policy }: Props) {
    ...
    const [data, setData] = useState({
        ...
        rules_before_14_days: (rules.before_14_days ?? 100).toString(),
        rules_before_7_days: (rules.before_7_days ?? 75).toString(),
        rules_after: (rules.after ?? 0).toString(),
    ...
    function handleSubmit(e: React.FormEvent) {
        ...
        router.put(`/admin/policies/${policy.id}`, {
            ...data,
    ...
    return (
        <>
            ...
            <header className="mb-8">
                <h2 className="font-display text-display-lg text-stitch-primary mb-2">Edit Policy</h2>
                <p className="text-body-lg text-stitch-on-surface-variant">{policy.name}</p>
            </header>
